...
<form action="<?= site_url('admin/artikel/artikel_addsave') ?>" method="POST" enctype="multipart/form-data">
    ...
    <input type="file" name="thumbnail_artikel" id="thumbnail_artikel" class="form-control" required>

    <label for="text">Artikel:</label>
    <textarea id="editor" required class="form-control" name="text" id="text" style="min-height: 200px;"></textarea>
