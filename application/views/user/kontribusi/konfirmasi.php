...
<div class="container">
	<div class="d-flex justify-content-center align-items-center vh-100">
		<div>
			<h2>Terimakasih telah memberikan kontribusi anda!</h2>
			<p>Silakan periksa email Anda (termasuk folder spam) untuk informasi lebih lanjut. Masukan Anda akan direview terlebih dahulu oleh admin sebelum dipublikasikan. Admin akan menghubungi Anda untuk proses selanjutnya.</p>
			<a href="<?= site_url('welcome/home') ?>" class="btn btn-primary">Kembali</a>
		</div>
	</div>
</div>
<!-- ***** Header Area End ***** -->
