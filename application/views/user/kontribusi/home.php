...
<div class="container">
	<div class="d-flex justify-content-center align-items-center vh-100">
		<div>
			<div class="mb-3">
				<h2>Selamat datang, Wistaka Kontributor!</h2>
				<p>Sekarang anda dapat mengusulkan iklan, wisata, dan event.</p>
			</div>		
			<div class="row g-2">
				<div class="col-lg-4 col-12">
					<div class="card" style="background: url('<?= base_url('assets/user/images/jogja.jpg') ?>') no-repeat center center/cover;">
						<div class="card-body">
							<h1 class="text-white">Iklan</h1>
						</div>
					</div>
				</div>
				<div class="col-md-4 px-lg-3 col-12">
					<a href="<?= site_url('kontribusi/wisata') ?>" class="card" style="background: url('<?= base_url('assets/user/images/jogja.jpg') ?>') no-repeat center center/cover;">
						<div class="card-body">
							<h1 class="text-white">Wisata</h1>
						</div>
					</a>
				</div>
				<div class="col-md-4 px-lg-3 col-12">
					<a href="<?= site_url('kontribusi/event') ?>" class="card" style="background: url('<?= base_url('assets/user/images/jogja.jpg') ?>') no-repeat center center/cover;">
						<div class="card-body">
